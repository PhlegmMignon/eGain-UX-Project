...
const answer1 = ref(store.answer1);
const answer2 = ref(store.answer2);
const answer3 = ref(store.answer3);
const answer4 = ref(store.answer4);
...
<template>
  <div class="flex flex-col gap-8">
    ...
    <NextBtn @click="submitForm" nextPage="/solution-feedback" />
  </div>
</template>
